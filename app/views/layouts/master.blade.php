        ...
        <div class="container">
            ...
            <nav class="navbar">
                <div class="container">
                    ...
                    <div class="row">
                        <ul class="navlist">
                            <li><a href="{{URL::route('catgory.show', array(1))}}">板块1</a></li>
                            <li><a href="{{URL::route('catgory.show', array(2))}}">板块2</a></li>
                            <li><a href="{{URL::route('catgory.show', array(3))}}">板块3</a></li>
                            <li><a href="{{URL::route('catgory.show', array(4))}}">板块4</a></li>
                        </ul>
                    </div>
                    <hr>
                </div>
